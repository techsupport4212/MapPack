...
return function(dsl)
    ...
    local era_one = DeepCoreState(require("eawx-states/tr-proteus-era-one"))
    local era_two = DeepCoreState(require("eawx-states/tr-proteus-era-two"))
    local era_three = DeepCoreState(require("eawx-states/tr-proteus-era-three"))
    local era_four = DeepCoreState(require("eawx-states/tr-proteus-era-four"))
    local era_five = DeepCoreState(require("eawx-states/tr-proteus-era-five"))
    local era_six = DeepCoreState(require("eawx-states/tr-proteus-era-six"))
    local era_seven = DeepCoreState(require("eawx-states/tr-proteus-era-seven"))
