...
return function(dsl)
    ...
    local era_one = DeepCoreState(require("eawx-states/tr-PROTEUSMAP-era-one"))
    local era_two = DeepCoreState(require("eawx-states/tr-PROTEUSMAP-era-two"))
    local era_three = DeepCoreState(require("eawx-states/tr-PROTEUSMAP-era-three"))
    local era_four = DeepCoreState(require("eawx-states/tr-PROTEUSMAP-era-four"))
    local era_five = DeepCoreState(require("eawx-states/tr-PROTEUSMAP-era-five"))
    local era_six = DeepCoreState(require("eawx-states/tr-PROTEUSMAP-era-six"))
    local era_seven = DeepCoreState(require("eawx-states/tr-PROTEUSMAP-era-seven"))
