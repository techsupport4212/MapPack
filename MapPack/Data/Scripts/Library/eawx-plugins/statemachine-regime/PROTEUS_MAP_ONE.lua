...
return function(dsl)
    ...
    local pestage = DeepCoreState(require("eawx-states/regimes/regime-pestage-PROTEUSMAP"))
    local isard = DeepCoreState(require("eawx-states/regimes/regime-isard-PROTEUSMAP"))
    local ccogm = DeepCoreState(require("eawx-states/regimes/regime-ccogm-PROTEUSMAP"))
    local thrawn = DeepCoreState(require("eawx-states/regimes/regime-thrawn-PROTEUSMAP"))
    local interregnum = DeepCoreState(require("eawx-states/regimes/regime-interregnum-PROTEUSMAP"))
    local palpatine = DeepCoreState(require("eawx-states/regimes/regime-palpatine-PROTEUSMAP"))
    local jax = DeepCoreState(require("eawx-states/regimes/regime-jax-PROTEUSMAP"))
    local daala = DeepCoreState(require("eawx-states/regimes/regime-daala-PROTEUSMAP"))
    local pellaeon = DeepCoreState(require("eawx-states/regimes/regime-pellaeon-PROTEUSMAP"))
