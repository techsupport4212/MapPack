...
function GovernmentEmpire:new(gc, absorb, dark_empire_available, id)
    ...
    if self.StartingEra >= 4 or dark_empire_available == false or GlobalValue.Get("PROTEUS_INFINITY") == true then
    ...
    crossplot:subscribe("PROTEUS_GENERIC_CONQUER", self.proteus_conquer_reward, self) --TechSupport: Subscribe to the new Proteus Conquer event
